...
export default function PatentsCompare() {
  ...
  const fetchPatents = async () => {
    try {
      const response = await axios.get("http://localhost:5500/api/v1/patent");
  ...
  return (
    <div className="bg-white flex flex-col">
      <h1 className="text-black text-3xl md:text-3xl lg:text-3xl mt-16 md:mt-7">
        Patents Overview
      </h1>
      ...
      <div className="bg-gray-50 shadow-lg rounded-2xl w-[100%] p-3 md:p-8">
        <div className="text-black text-2xl">Patents Information</div>
