...
import {  Book, Microscope, Users, User } from "lucide-react";
      ...
      <div className="relative z-10 pt-12 px-4 md:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 pb-16">
          ...
          <div className="group relative overflow-hidden rounded-xl backdrop-blur-sm bg-white/10 border border-white/20 p-6 transition-all duration-300 hover:bg-white/20 hover:scale-105">
            ...
            <h3 className="font-semibold text-2xl text-white mb-2">Department</h3>
          </div>
          </Link>
          ...
          <div className="group relative overflow-hidden rounded-xl backdrop-blur-sm bg-white/10 border border-white/20 p-6 transition-all duration-300 hover:bg-white/20 hover:scale-105">
            ...
            <h3 className="font-semibold text-2xl text-white mb-2">User</h3>
          </div>
          </Link>
