...
export default function SportsCulturalAnalyze () {
    ...
    const handleDateFilter = async () => {
        try {
            const response1 = await axios.get(`http://localhost:5000/publications?starttime=${filterStartDate1}&endtime=${filterEndDate1}`, {
            ...
            const response2 = await axios.get(`http://localhost:5000/publications?starttime=${filterStartDate2}&endtime=${filterEndDate2}`, {
                headers: { 'Content-type': 'application/json' }
            });
